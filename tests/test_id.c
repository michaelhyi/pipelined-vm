...
void test_id_add_register_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 7;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0x1401; // ADD R2 = R0 + R1
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_add_immediate_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 7;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0x143D; // ADD R2 = R0 + imm5(-3)
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_and_register_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 7;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0x5401; // AND R2 = R0 & R1
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_and_immediate_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 7;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0x543D; // AND R2 = R0 & imm5(-3)
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_not_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 6;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = (int16_t)0x973F; // NOT R3 = NOT R4
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_br_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 5;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0xD01; // BRnz, PCoffset9=1
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_jmp_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 4;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = (int16_t)0xC1C0; // JMP base_r=1
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_jsr_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 4;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0x481F; // JSR, PCoffset11=31
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_jsrr_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 4;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0x4180; // JSRR base_r=1
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_ld_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 5;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0x2A00; // LD DR=5, PCoffset9=0
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_ldi_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 5;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = (int16_t)0xA61E; // LDI DR=3, PCoffset9=30
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_ldr_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 6;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = 0x6801; // LDR DR=4, base_r=0, offset6=1
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_lea_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 5;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = (int16_t)0xE003; // LEA DR=0, PCoffset9=3
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_st_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 5;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = (int16_t)0x340F; // ST SR=2, PCoffset9=15
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_sti_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 5;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = (int16_t)0xB46A; // STI SR=2, PCoffset9=106
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_str_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 6;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = (int16_t)0x7900; // STR SR=4, base_r=4, offset6=0
    pthread_t tid;
    dbuf_t dbuf;
...
void test_id_trap_exec_cycle(int *passed_tests, int *total_tests) {
    *total_tests += 4;
    vm.fbuf.pc = 0x3001;
    vm.fbuf.instruction = (int16_t)0xF025; // TRAP vect8=0x25
    pthread_t tid;
    dbuf_t dbuf;
